    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Experienced developer proficient in JavaScript, PHP, C#, Python and C, with a
          strong focus on selecting the best technology for each project.
          Currently exploring the potential of Rust and Zig to further enhance
          my skill set.
        </Paragraph>
        <Paragraph className=" mt-4">
        ...
        <Paragraph className=" mt-4">
          I prioritize clean code and robust solutions, and I enjoy working in
          dynamic teams to bring innovative ideas to life
        </Paragraph>
        <Paragraph className=" mt-4">
